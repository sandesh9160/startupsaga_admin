...
export interface Startup {
    ...
    logo: string;
    tagline?: string;
    category: string | Category; // Can be string or object depending on fetch depth
    categorySlug?: string;
    city: string | Hub; // Can be string or object depending on fetch depth
    citySlug?: string;
    website_url?: string;
    description: string;
    ...
    sector?: string;
    team_size?: string;
    founders_data?: Record<string, unknown>[];
    is_featured?: boolean;
    status?: string;
    meta_title?: string;
    meta_description?: string;
